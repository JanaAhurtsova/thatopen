...
async function exportFragments(fragments: OBC.FragmentsManager) {
  ...
  return BUI.Component.create<BUI.PanelSection>(() => {
    return BUI.html`
      <bim-toolbar-section label="Import" icon="solar:import-bold">
        ...
        <bim-button @click=${exportFrag} label="Export" icon="fluent:puzzle-cube-piece-20-filled" tooltip-title="Load Fragments"
          tooltip-text="Loads a pre-converted IFC from a Fragments file. Use this option if you want to avoid the conversion from IFC to Fragments."></bim-button>
      </bim-toolbar-section>
    `;
  });
